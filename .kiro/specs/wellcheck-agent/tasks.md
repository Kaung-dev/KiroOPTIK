# Tasks: WellCheck Agent

- [x] 1. Create Kiro steering files for product, technical, safety, and demo constraints.
- [x] 2. Create Kiro requirements with user stories and EARS-style acceptance criteria.
- [x] 3. Create technical design covering data flow, risk scoring, safety, and demo flow.
- [x] 4. Create static sample patient data from the challenge inputs.
- [x] 5. Build a browser demo with patient profile, care plan, conversation, transcript, and alert queue.
